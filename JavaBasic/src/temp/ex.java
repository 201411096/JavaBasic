...
public class ex{
	public static void main(String[] args)
	{
		...
		scanner.nextLine();
		String testNum[] = new int [testCase];
		...
		for(int i=0; i<testCase; i++)
		{
			...
			int temp = testNum[i]; //n진법에서의 자릿수를 구하는데 사용할 변수
			...
			int temp2 = testNum[i];
			int testNum_in_testDigit[] = new int[testNum_digitCnt]; //n진법에서의 자릿수만큼 배열 지정
