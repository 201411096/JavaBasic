package t_teamproject.teamproject_01;
...
public class MainFrame extends JFrame implements ActionListener{
	...
	//메인화면으로 사용할  
	private ImageIcon mainScreen = new ImageIcon("src/t_teamproject/teamproject_01/imgs/main.jpg");
	...
	public MainFrame() {
		...
		{
			imageIconArray[i] = new ImageIcon("src/t_teamproject/teamproject_01/imgs/" + i +".png"); // 각 이미지들을 불러옴
			mostImageIconArray[i] = new ImageIcon("src/t_teamproject/teamproject_01/imgs/0_" +i+".jpg" ); // 가장 많이 팔린 메뉴의 이미지들
